...
function Skills() {
  return (
    <motion.div className='flex flex-col relative text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center px-4' initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 4 }}>
      ...
      <div className='grid grid-cols-4 gap-5 top-44'>
        ...
        <Skill link='https://img.icons8.com/windows/512/vuetify.png' />
        <Skill link='https://img.icons8.com/color/512/nodejs.png' />
        <Skill link='https://img.icons8.com/ios-filled/512/console.png' />
