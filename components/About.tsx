...
function About() {
  return (
    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1.5 }} className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
      <h3 className='absolute top-24 uppercase tracking-[30px] text-gray-500 text-2xl'>About</h3>
      ...
      <div className='space-y-10 px-0 md:px-10'>
        ...
        <p className='text-base'>
          Experienced senior full stack software engineer adept in end-to-end development and project delivery from initial concept to final deployment, complemented by a strong ability to lead teams and projects and deliver high-quality user-centric solutions. <br />
          <br />
